...
export declare function downloadMMDB(sourceName?: string): Promise<void>;
export declare function removeMMDB(): void;
export declare function getGeolocation(ip: string, geoipDb?: string): Promise<Geolocation>;
export {};
